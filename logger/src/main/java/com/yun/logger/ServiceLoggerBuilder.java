package com.yun.logger;

import android.os.Environment;

import com.yun.logger.util.TimeFormatUtil;
...
public class ServiceLoggerBuilder {
    ...
    public ServiceLoggerBuilder catchCrash(boolean isCatchCrash) {
        if (isCatchCrash && crashLogger == null) {
            ...
            crashLogger = new ServiceLogger(true, new File(Environment.getExternalStorageDirectory()
                    .getAbsolutePath() + "/" + DEFAULT_CRASH_LOG_FOLDER_PATH), saveDays, true, false);
